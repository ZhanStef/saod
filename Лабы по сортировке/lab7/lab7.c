...
//	scanf("%d",&n);
	for(n=100;n<=1000;n+=100){
		...
		x=(int)rand()%n;
		compareV1=0;
		binsearchV1(M, n, M[x], &compareV1);
		compareV2=0;
		binsearchV2(M, n, M[x], &compareV2);
		printf("\nКоличество сравнений для массива размером %d для V1=%d, V2=%d", n, compareV1, compareV2);
		free(M);
		M=NULL;
	}
	return 0;
